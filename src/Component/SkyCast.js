...
function SkyCast() {
    ...
    return (
            ...
            {weather && weather.data && weather.data.main && (<div className='sky-card'>
                 ...
                 <p className='footer'>Web Designed by <a href='https://github.com/er-arunkumarselvam' target='_blank' rel="noreferrer" className='underline underline-offset-2 font-semibold text-gray-950' >Arunkumar.</a> </p>
                </div>)};
